        ...
        <div class="page-content-wrapper m-2 w-100">
            ...
            <div class="container-fluid p-0">
                <div class="bg-white shadow-sm p-2">
                    <div class="px-4 pt-3">
                        <h1 class="mb-4">Edit Data Product</h1>

                        <form action="updatedataproduct.php" method="post">
                            <div class="mb-3">
                                <label for="product_id" class="col-form-label">Product ID</label>
                                <input type="text" disabled value="<?php echo $row["product_id"]; ?>" class="form-control rounded-0 disabled" name="product_id" required>
                                <input type="hidden" value="<?php echo $row["product_id"]; ?>" class="form-control rounded-0 disabled" name="product_id" required>
                            </div>
                            <div class="mb-3">
                                <label for="product_name" class="col-form-label">Product Name</label>
                                <input type="text" value="<?php echo $row["product_name"]; ?>" class="form-control rounded-0" name="product_name" id="product_name" required>
                            </div>

                            <div class="mb-3">
                                <label for="price" class="col-form-label">Price</label>
                                <input type="number" value="<?php echo $row["price"]; ?>" min="1" name="price" class="form-control rounded-0" id="price" required>
                            </div>

                            <div class="mb-3">
                                <label for="detail" class="col-form-label">Detail</label>
                                <input type="text" value="<?php echo $row["detail"]; ?>" name="detail" class="form-control rounded-0" id="detail" required>
                            </div>
            
                            <div class="mb-3">
                                <label for="image" class="col-form-label">Product Image</label>
                                <input type="file" value="" name="image" accept=".jpg, .jpeg, .png" class="form-control rounded-0" id="image" required>
                            </div>
